...
namespace WpfDiploma
{
    public class RungeKutClass
    {
        ...
        private void ChangeSideLiapunov(double t, double[] yp, CustomPoint y, Derives derives) 
        {
            yp[0] = derives.DpsiDy(y.Coordinates[0], y.Coordinates[1], t);
            yp[1] = -derives.DpsiDx(y.Coordinates[0], y.Coordinates[1], t);
            yp[2] = derives.DuDx(y.Coordinates[0], y.Coordinates[1], t) * y.Coordinates[3] + derives.DuDy(y.Coordinates[0], y.Coordinates[1], t) * y.Coordinates[2];
            yp[3] = derives.DvDx(y.Coordinates[0], y.Coordinates[1], t) * y.Coordinates[2] + derives.DvDy(y.Coordinates[0], y.Coordinates[1], t) * y.Coordinates[3];
        }

        public void Runge_Kut_Liapunov(CustomPoint coordinate, Derives derives)
        {
            ...
            for (int it = 0; it < nt; it++)
            {
                ...
                ChangeSideLiapunov(CurrentTime, yp, coordinate, derives);
                ...
                ChangeSideLiapunov(tt, yp, coordinate, derives);
